...
<header class="site-header">
    <div class="container">
        <h1><a href="/">nano cares卡爾氏 Blog</a></h1>
        <nav class="site-header-nav" role="navigation">
            <a href="/" class=" site-header-nav-item" title="首頁">首頁</a>
            @if(!empty($navList))
            ...
            <form class="demo_search" action="{{url('search/keyword')}}" method="get">
                ...
                <input class="demo_sinput" type="text" name="keyword" id="search_input" placeholder="請輸入要搜尋的文章標題" />
            </form>
        </nav>
