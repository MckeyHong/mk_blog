...
@section('header')
    <title>搜索標籤{{ $tagName }}_{{ systemConfig('title','Enda Blog') }}-Powered By{{ systemConfig('subheading','Enda Blog') }}</title>
        ...
        <div class="column two-thirds" >
            <ol class="repo-list">
                ...
                @else
                    ...
                    <li class="repo-list-item">
                        <h3 class="repo-list-name">
                            暂時没搜到關於標籤 <span style="color: #f4645f">{{ $tagName }}</span> 的内容，換個關鍵字試試吧～
                        </h3>
                    </li>
                @endif
            </ol>
