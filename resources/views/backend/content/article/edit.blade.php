                ...
                <div class="panel-body">
                    {!! Form::model($article, ['route' => ['backend.article.update', $article->id], 'method' => 'put','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">標題</label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">所屬分類</label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                {!! Form::text('tags', '', ['class' => 'form-control','placeholder'=>'確認送出','id'=>'tags']) !!}
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">封面圖</label>
                            <div class="col-sm-7">
                                {!! Form::file('pic') !!}
